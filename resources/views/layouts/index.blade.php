    ...
    <body>
                        ...
                        <div class="col-sm-6">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    <li><a href="#"><i class="fa fa-phone"></i> +8801680342734 </a></li>
                                    <li><a href="#"><i class="fa fa-envelope"></i> info@fulerhut.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a href="{{URL::to('/')}}"><img src="{{asset('public/images/home/logo/fuler-hat-logo.jpg')}}" alt=" Fulerhut Logo " /></a>
                            </div>
                            <!--
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="{{URL::to('/login-in')}}"><i class="fa fa-lock"></i> Login</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mainmenu pull-left">
                                ...
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    ...
                                    foreach ($all_published_category as $menu_list) {
                                        ?>
                                        <li><a href="{{URL::to('/flower-category/'.$id = $menu_list->category_id)}}"><?php echo $menu_list->category_name; ?></a></li>
                                    <?php } ?>
                            </div>
                        </div>
                        <div class="col-sm-3">
        ...
        <footer id="footer"><!--Footer-->
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <p class="pull-left">Copyright © 2018 Fulerhut.com. All rights reserved.</p>
