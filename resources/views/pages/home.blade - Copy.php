            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item {{ $loop->first ? ' active' : '' }}" >
                    ...
                    <div class="col-sm-3">
                        ...
                        <p>{{ str_limit(strip_tags($slider->product_description), 200) }}
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                ...
                                <div class="product-overlay">
                                    ...
                                    {{-- This Input for Ajax add-to-cat id --}}
                                    <input type="hidden" name="product_id" id="product_id<?php echo $countProduct; ?>" value="{{$product->product_id}}">
