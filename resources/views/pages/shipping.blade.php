        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h2 class="text-center text-success">Welcome <b><?php echo isset($_SESSION['customer_name']) ?></b>.You have to give us shipping information to complete your valuable order. If your billing information and  shipping information are same then just press on Save Shipping Info Button</h2>
                </div>
            </div>
        </div>
    </div>
